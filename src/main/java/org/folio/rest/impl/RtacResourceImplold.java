...
//import org.folio.clients.InventoryFacade;
...
//
//
//    final InventoryFacade inventoryFacade = new InventoryFacade(okapiHeaders);
//
//    inventoryFacade.getItemAndHoldingInfo(List.of(id))
...
//      .onFailure(t -> asyncResultHandler.handle(Future.failedFuture(t)));
//  }
//
//
//
//  private CompletableFuture<RtacHoldings> convertFolioItemListToRtac(
//    Map<CompletableFuture<Response>,
//      String> cfs) {
//    return CompletableFuture.allOf(cfs.keySet().toArray(new CompletableFuture[cfs.size()]))
//      .thenApply(result -> {
//        final RtacHoldings holdings = new RtacHoldings();
//        final List<RtacHolding> holdingList = new ArrayList<>();
//
...
//  }
//
//  private RtacHolding convertFolioItemToRtacHolding(final String callNumber, final Object o) {
//    if (!(o instanceof JsonObject)) {
//      return null;
//    }
//
//    final JsonObject item = (JsonObject) o;
//    final RtacHolding holding = new RtacHolding();
//
...
//  }
//
//  CompletableFuture<RtacHoldings> getItems(JsonArray holdingsRecords,
//                                       HttpClientInterface httpClient, Map<String, String> okapiHeaders) {
...
//  }
//
//  CompletableFuture<RtacHoldings> checkForLoans(RtacHoldings holdings,
//                                            HttpClientInterface httpClient, Map<String, String> okapiHeaders) {
//    final Map<RtacHolding, CompletableFuture<Response>> cfs = new HashMap<>();
//
//    for (RtacHolding holding : holdings.getHoldings()) {
//      try {
//        cfs.put(holding,
...
//  }
//
//  private CompletableFuture<RtacHoldings> assignDueDates(RtacHoldings holdings,
//                                                     Map<RtacHolding, CompletableFuture<Response>> cfs) {
...
//  }
//
//  void assignDueDate(RtacHolding holding, JsonObject responseBody) {
...
//      }
//      if (dueDate != null) {
//        holding.setDueDate(dueDate.toString());
//      }
//    }
//  }
//
