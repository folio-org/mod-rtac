...
public class MockServer {
  ...
  private void handleInventoryViewResponse(RoutingContext routingContext) {
    routingContext.request().bodyHandler(body -> {
      ...
      if (jsonArray.contains("76d5a72a-af24-4ac6-8e73-4e39604f6f59")) {
        successResponse(routingContext, getJsonObjectFromFile(INVENTORY_VIEW + "76d5a72a-af24-4ac6-8e73-4e39604f6f59.json"));
...
////        successResponse(routingContext, getJsonObjectFromFile());
        ...
        failureResponse(routingContext, HttpStatus.SC_NOT_FOUND, format("there is no mock handler for request:%s", routingContext.request().uri()));
      }
    });
  }
