...
public class MockData {
  ...
  public static final String INSTANCE_ID_HOLDING_NO_CALL_NUMBER =
      "6b5678bb-2943-4efe-9c0a-f46d349f0511";
  ...
  public static final InventoryHoldingsAndItems INSTANCE_WITH_HOLDING_NO_CALL_NUMBER;
  ...
  public static final RtacRequest RTAC_REQUEST_WITH_INSTANCE_HOLDING_NO_CALL_NUMBER;
  ...
  static {
    ...
    INSTANCE_WITH_HOLDING_NO_CALL_NUMBER =
        stringToPojo(INSTANCE_WITH_ITEM_AND_HOLDING_TEMPLATE, InventoryHoldingsAndItems.class)
            .withInstanceId(INSTANCE_ID_HOLDING_NO_CALL_NUMBER);
    INSTANCE_WITH_HOLDING_NO_CALL_NUMBER.setItems(Collections.emptyList());
    INSTANCE_WITH_HOLDING_NO_CALL_NUMBER.getHoldings().get(0).setCallNumber(null);
    ...
    RTAC_REQUEST_WITH_INSTANCE_HOLDING_NO_CALL_NUMBER =
        new RtacRequest()
            .withInstanceIds(Collections.singletonList(INSTANCE_ID_HOLDING_NO_CALL_NUMBER));
